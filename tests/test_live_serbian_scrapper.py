...
static_route_example = (
    "https://www.bgprevoz.rs/linije/red-voznje/linija/2/prikaz"
)
...
def test_switch_to_latin():
    ...
    global test_counter
    test_counter += 1
    print(f"Test #{test_counter} passed. You're using latin alphabet.")
...
def test_language_change():
    ...
    global test_counter
    test_counter += 1
    print(f"Test #{test_counter} passed. You're using cyrillic alphabet.")
...
def test_pdfless_links_collector():
    ...
    test_counter += 1
    print(
        f"Test #{test_counter} passed. Links without *.pdf "
        "are collected correctly."
    )


def test_links_collector_as_a_whole():
    start_path = "/linije/red-voznje"
    with open(rf"{base_path}test_stylesheets.txt", "r") as test_stylesheets:
    ...
    test_counter += 1
    print(
        f"Test #{test_counter} passed. Any links are being collected "
        "correctly."
    )
...
def test_getting_class_instance():
    ...
    test_counter += 1
    print(
        f"Test #{test_counter} passed. Route is instance "
        "of BelgradRoute class."
    )
...
def test_route_name_attribute():
    ...
    test_counter += 1
    print(
        f"Test #{test_counter} passed. Route's name is correct "
        "in class instance."
    )
