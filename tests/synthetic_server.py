...
app = Flask(__name__)
app.static_folder = (
    "templates/static/Секретаријат за јавни превоз _ Ред вожње_files"
)
...
def render_line_2():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 2.html"
    )
...
def render_line_18():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 18.html"
    )
...
def render_line_21a():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 21A.html"
    )
...
def render_line_23():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 23.html"
    )
...
def render_line_400():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 400.html"
    )
...
def render_line_451a():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 451а.html"
    )
...
def render_line_460a():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 460а.html"
    )
...
def render_line_465():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 465.html"
    )
...
def render_line_493():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 493.html"
    )
...
def render_line_581a():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 581а.html"
    )
...
def render_line_4404a():
    return render_template(
        "Секретаријат за јавни превоз _ Ред вожње линија 4404а.html"
    )
